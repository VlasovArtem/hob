...
import (
	...
	service "github.com/VlasovArtem/hob/src/income/service"
...
func (_m *IncomeService) AddBatch(request model.CreateIncomeBatchRequest) ([]model.IncomeDto, error) {
	ret := _m.Called(request)

	var r0 []model.IncomeDto
	if rf, ok := ret.Get(0).(func(model.CreateIncomeBatchRequest) []model.IncomeDto); ok {
		r0 = rf(request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.IncomeDto)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(model.CreateIncomeBatchRequest) error); ok {
		r1 = rf(request)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IncomeService) Transactional(tx *gorm.DB) service.IncomeService {
	ret := _m.Called(tx)

	var r0 service.IncomeService
	if rf, ok := ret.Get(0).(func(*gorm.DB) service.IncomeService); ok {
		r0 = rf(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(service.IncomeService)
		}
	}
...
type mockConstructorTestingTNewIncomeService interface {
	mock.TestingT
	Cleanup(func())
}

// NewIncomeService creates a new instance of IncomeService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIncomeService(t mockConstructorTestingTNewIncomeService) *IncomeService {
	mock := &IncomeService{}
	mock.Mock.Test(t)
