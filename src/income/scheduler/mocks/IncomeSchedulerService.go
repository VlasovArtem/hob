...
import (
	...
	service "github.com/VlasovArtem/hob/src/income/scheduler/service"
...
func (_m *IncomeSchedulerService) Transactional(tx *gorm.DB) service.IncomeSchedulerService {
	ret := _m.Called(tx)

	var r0 service.IncomeSchedulerService
	if rf, ok := ret.Get(0).(func(*gorm.DB) service.IncomeSchedulerService); ok {
		r0 = rf(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(service.IncomeSchedulerService)
		}
	}
...
type mockConstructorTestingTNewIncomeSchedulerService interface {
	mock.TestingT
	Cleanup(func())
}

// NewIncomeSchedulerService creates a new instance of IncomeSchedulerService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIncomeSchedulerService(t mockConstructorTestingTNewIncomeSchedulerService) *IncomeSchedulerService {
	mock := &IncomeSchedulerService{}
	mock.Mock.Test(t)
