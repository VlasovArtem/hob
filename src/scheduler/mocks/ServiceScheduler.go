...
type mockConstructorTestingTNewServiceScheduler interface {
	mock.TestingT
	Cleanup(func())
}

// NewServiceScheduler creates a new instance of ServiceScheduler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewServiceScheduler(t mockConstructorTestingTNewServiceScheduler) *ServiceScheduler {
	mock := &ServiceScheduler{}
	mock.Mock.Test(t)
